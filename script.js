...
const getSymptomInfo = async (symptoms) => {
 ...
 const apiKey = "AIzaSyDUe3IG3UogjcNMIkg4o0fHSPMZRs1KvJ0"; 
    ...
    const requestBody = {
        contents: [
            {
                role: "user",
                parts: [{ text: "You are a concise, friendly, and easy-to-understand Medical Assistant. Your only function is to provide information related to **medical conditions, diseases, health, and anatomy**. For any topic outside of this domain, you **MUST** respond with the exact phrase: 'This system only provide information that disease or medical related.'" }]
            },
            {
                role: "user",
                parts: [{ text: "You are a concise, friendly, and easy-to-understand assistant. Explain complex topics using simple language, short sentences, and where appropriate, use bullet points or numbered lists for readability. Keep your response to a maximum of 100 words." }]
            },
            {
                role: "user",
...
                },
    {
                    role: "user", 
                    parts: [
                        { text: "You are a concise, friendly, and easy-to-understand assistant. Explain complex topics using simple language, short sentences, and where appropriate, use bullet points or numbered lists for readability. Keep your response to a maximum of 100 words.Always say the symptoms" } 
                    ]
                },
